...
var AddCarComponent = /** @class */ (function () {
    ...
    AddCarComponent.prototype.saveCar = function () {
        var _this = this;
        this.subscriptions.push(this.service.createCar(this.parseCar()).subscribe(function () {
        }));
        setTimeout(function () { return _this.addingForm(); });
    ...
    AddCarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"],
            _services_cars_service__WEBPACK_IMPORTED_MODULE_4__["CarsService"],
...
var CarsComponent = /** @class */ (function () {
    function CarsComponent(service, loadingService) {
        this.service = service;
    ...
    CarsComponent.prototype.deleteCar = function (car) {
        ...
        if (confirm('Are you sure you want to delete this car?')) {
            ...
            this.subscriptions.push(this.service.deleteCar(car).subscribe(function () {
                _this.loadCars();
            }));
    ...
    CarsComponent.prototype.loadCars = function () {
        var _this = this;
        this.loadingService.show();
        this.subscriptions.push(this.service.cars.subscribe(function (cars) {
            _this.cars = cars;
